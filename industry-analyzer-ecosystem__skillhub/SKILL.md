...
description: Map the supply chain ecosystem of a given industry — identify
  upstream/midstream/downstream/horizontal-support positions and representative
  companies at each. Use when user asks for '生态图谱', '供应链分析', 'industry ecosystem
  map', '产业图谱', '行业生态', '产业链'. Outputs markdown with 4-生态位 breakdown + Mermaid
  diagram. Part of the industry-analyzer plugin (6-Skill 流水线第 2 环).
