...
1. 用 `extract_md.py` 提取该目录下所有 md 的标题层级 + 开头摘要：
   ```bash
   python3 /Users/tianwenliang/.agents/skills/PRODUCTIVITY/vault-batch-distiller/scripts/extract_md.py \
...
4. 校验死链：
   ```bash
   python3 /Users/tianwenliang/.agents/skills/PRODUCTIVITY/vault-batch-distiller/scripts/validate_links.py \
