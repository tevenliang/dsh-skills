...
| `bilibili search` | `<query>` (positional, required), `--type video\|user`, `--page N`, `--limit N` | 搜索视频或用户 |
...
| Command | Args | Description |
|---------|------|-------------|
| `boss search` | `<query>` (positional, required), `--city <城市>`, `--experience <经验>`, `--degree <学历>`, `--salary <薪资>`, `--industry <行业>`, `--page N`, `--limit N` (default 15) | 搜索职位 |
...
| Command | Args | Description |
|---------|------|-------------|
| `ctrip search` | `<query>` (positional, required), `--limit N` (default 15) | 搜索城市或景点 |
...
| `reddit search` | `<query>` (positional, required), `--limit N` | 搜索帖子 |
...
| Command | Args | Description |
|---------|------|-------------|
| `reuters search` | `<query>` (positional, required), `--limit N` (default 10, max 40) | 搜索新闻 |
...
| Command | Args | Description |
|---------|------|-------------|
| `smzdm search` | `<query>` (positional, required), `--limit N` (default 20) | 搜索好价商品 |
...
| `twitter search` | `<query>` (positional, required), `--limit N` (default 15) | 搜索推文 |
...
| `xiaohongshu search` | `<query>` (positional, required), `--limit N` (default 20) | 搜索笔记 |
...
| `xueqiu search` | `<query>` (positional, required), `--limit N` (default 10) | 搜索股票（代码或名称）|
...
| Command | Args | Description |
|---------|------|-------------|
| `youtube search` | `<query>` (positional, required), `--limit N` (default 20, max 50) | 搜索视频 |
...
| `zhihu search` | `<query>` (positional, required), `--limit N` (default 10) | 搜索内容 |
